...
#include <franka_control_inrol/inrol_peg_in_hole.h>
...
bool InrolPegInHole::init(hardware_interface::RobotHW* robot_hw,
                                               ros::NodeHandle& node_handle) {
  std::vector<double> cartesian_stiffness_vector;
  std::vector<double> cartesian_damping_vector;

  sub_equilibrium_pose_ = node_handle.subscribe(
      "/equilibrium_pose", 1000, &InrolPegInHole::equilibriumPoseCallback, this,
  ...
  dynamic_server_compliance_param_->setCallback(
      boost::bind(&InrolPegInHole::complianceParamCallback, this, _1, _2));
...
void InrolPegInHole::starting(const ros::Time& /*time*/) {
...
void InrolPegInHole::update(const ros::Time& /*time*/,
...
Eigen::Matrix<double, 7, 1> InrolPegInHole::saturateTorqueRate(
...
void InrolPegInHole::complianceParamCallback(
...
void InrolPegInHole::equilibriumPoseCallback(
...
PLUGINLIB_EXPORT_CLASS(franka_control_inrol::InrolPegInHole,
