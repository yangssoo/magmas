...
#include <franka_control_inrol/inrol_impedance_controller.h>
...
bool InrolImpedanceController::init(hardware_interface::RobotHW* robot_hw,
                                               ros::NodeHandle& node_handle) {
  std::vector<double> cartesian_stiffness_vector;
  std::vector<double> cartesian_damping_vector;

  sub_equilibrium_pose_ = node_handle.subscribe(
      "/equilibrium_pose", 20, &InrolImpedanceController::equilibriumPoseCallback, this,
  ...
  dynamic_server_compliance_param_->setCallback(
      boost::bind(&InrolImpedanceController::complianceParamCallback, this, _1, _2));
...
void InrolImpedanceController::starting(const ros::Time& /*time*/) {
...
void InrolImpedanceController::update(const ros::Time& /*time*/,
 ...
 // std::cout<<orientation_d_target_.x()<<" "<<orientation_d_target_.y()<<" "<<orientation_d_target_.z()<<" "<<orientation_d_target_.w()<<" "<<std::endl;
 // std::cout<<" "<<std::endl;


}

Eigen::Matrix<double, 7, 1> InrolImpedanceController::saturateTorqueRate(
...
void InrolImpedanceController::complianceParamCallback(
...
void InrolImpedanceController::equilibriumPoseCallback(
...
PLUGINLIB_EXPORT_CLASS(franka_control_inrol::InrolImpedanceController,
